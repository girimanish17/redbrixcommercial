...
?>
				...
				<div class="form-group">
				  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Current Home Slider Image <span class="required"></span>
				  </label>
				  <div class="col-md-6 col-sm-6 col-xs-12">
				  <a href="<?php echo base_url()?>uploads/projects/<?php if($data) { echo $data->home_slider_image;} ?>" target="blank"><img src="<?php echo base_url()?>uploads/projects/<?php if($data) { echo $data->home_slider_image;} ?>" alt="home slider Image" width="25%;"></a>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="file" name="home_slider_image" value="" class="form-control col-md-7 col-xs-12 ">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="pr_title4" name="pr_title4" value="<?php echo $ret[3]->pr_title; ?>" placeholder="Add Retail Title" class="form-control col-md-7 col-xs-12 <?php if(form_error('pr_title4')){ echo "parsley-error"; } ?>">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="pr_size4" name="pr_size4" value="<?php echo $ret[3]->pr_size; ?>" placeholder="Add Retail Size" class="form-control col-md-7 col-xs-12 <?php if(form_error('pr_size4')){ echo "parsley-error"; } ?>">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="pr_price4" name="pr_price4" value="<?php echo $ret[3]->pr_price; ?>" placeholder="Add Retail Price" class="form-control col-md-7 col-xs-12 <?php if(form_error('pr_price4')){ echo "parsley-error"; } ?>">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<select class="form-control col-md-7 col-xs-12 <?php if(form_error('pr_type4')){ echo "parsley-error"; } ?>" id="pr_type4" name="pr_type4">
						<option value="">Select Type</option>
						<?php if($retail_type) { foreach($retail_type as $row){  ?>
							<option <?php if($ret[3]->pr_type == $row->id) { echo 'selected'; } ?> value="<?php echo $row->id; ?>"><?php echo $row->type; ?></option>
						<?php }} ?>
					</select>
				...
				<div class="form-group">
				  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Current Project Highlights Image <span class="required"></span>
				  </label>
				  <div class="col-md-6 col-sm-6 col-xs-12">
				  <a href="<?php echo base_url()?>uploads/projects/<?php if($data) { echo $data->highlight_bg_image;} ?>" target="blank"><img src="<?php echo base_url()?>uploads/projects/<?php if($data) { echo $data->highlight_bg_image;} ?>" alt="bg Image" width="25%;"></a>
				  </div>
				</div>
				...
				<div class="form-group">
				  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Current Project Amenties Image <span class="required"></span>
				  </label>
				  <div class="col-md-6 col-sm-6 col-xs-12">
				  <a href="<?php echo base_url()?>uploads/projects/<?php if($data) { echo $data->amenties_bg_image;} ?>" target="blank"><img src="<?php echo base_url()?>uploads/projects/<?php if($data) { echo $data->amenties_bg_image;} ?>" alt="bg Image" width="25%;"></a>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="right_option1" name="right_option1" value="<?php echo $data->right_option1; ?>" placeholder="Option 1" class="form-control col-md-7 col-xs-12 ">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="right_option2" name="right_option2" value="<?php echo $data->right_option2; ?>" placeholder="Option 2" class="form-control col-md-7 col-xs-12 ">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="right_option3" name="right_option3" value="<?php echo $data->right_option3; ?>" placeholder="Option 3" class="form-control col-md-7 col-xs-12 ">
				...
				<div class="form-group">
				  ...
				  <div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" autocomplete="off" id="right_option4" name="right_option4" value="<?php echo $data->right_option4; ?>" placeholder="Option 4" class="form-control col-md-7 col-xs-12 ">
