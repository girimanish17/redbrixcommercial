                        ...
                        <tr>
                          ...
                          <td><?php echo $row->date; ?></td>
						   <td>
								...
								<a href="<?php echo base_url(); ?>admin/delete_list/<?php echo $row->id ?>/pEnquiry" onclick="return confirm('Do you want to delete this.');" class="btn btn-danger">Delete</a>
							</td>
                        </tr>
                        <?php }} ?>
                      </tbody>
