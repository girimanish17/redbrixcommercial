                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">            
                            <div class="menu_section">              
                                ...
                                <ul class="nav side-menu">                
                                    ...
                                    <li><a><i class="fa fa-qrcode"></i> Enquiries <span class="fa fa-chevron-down"></span></a>                  
                                    <ul class="nav child_menu" style="display: none">                    
                                    <li><a href="<?php echo base_url('admin/contact_enquiry'); ?>">Contact Enquiry</a></li>                    
                                    <li><a href="<?php echo base_url('admin/project_enquiry'); ?>">Project Enquiry</a></li>                                     
                                    <li><a href="<?php echo base_url('admin/enquiries'); ?>"> Home Enquiry</a></li>                                     
                                    <li><a href="<?php echo base_url('admin/subscribed_email'); ?>"> Subscribed Email</a></li>                                     
                                                                     
                                 </ul>                </li>				
                                    <li><a><i class="fa fa-qrcode"></i> Gallery <span class="fa fa-chevron-down"></span></a>                  
                                    <ul class="nav child_menu" style="display: none">                    
                                    <li><a href="<?php echo base_url('admin/add_gallery_image'); ?>">Add Image</a></li>                    
                                    <li><a href="<?php echo base_url('admin/gallery_list'); ?>">Gallery List</a></li>                    
                                                                     
                                                                     
                                 </ul>                </li>			

<li><a href="<?php echo base_url('admin/edit_home_banner'); ?>"><i class="fa fa-list"></i> Home Banner</a> </li> 
