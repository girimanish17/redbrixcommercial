<!-- Hero Area -->
<section class="propertybanner clearfix" style="background: url(<?php echo base_url() ?>uploads/projects/<?php if($pro_details){ echo $pro_details->bg_image; } ?>) center -150px no-repeat fixed; background-size: cover;">
	<div class="container">
...
<g>
					...
					<li>
						...
						Located on Noida Expressway</li>
				</ul>
...
<section class="highlightwrap clearfix"  style="background: url(<?php echo base_url() ?>uploads/projects/<?php if($pro_details){ echo $pro_details->highlight_bg_image; } ?>) center -200px no-repeat; background-size: cover;">
	<div class="container">
		<div class="highbox">
			<h2>Project's</h2>
			<h3>Highlights</h3>
...
<section class="ProjectAmenities clearfix"  style="background: url(<?php echo base_url() ?>uploads/projects/<?php if($pro_details){ echo $pro_details->amenties_bg_image; } ?>) center -250px no-repeat; background-size: 100%; text-align: center;">
	<div class="container">
		<h2>Project</h2> 
		<h3>Amenities</h3>
		<ul>
...
<div class="galleryview clearfix">
	<div class="container">
		<h2>Gallery</h2>
		<h3>Gaur City Center</h3>
		
		<ul>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery1.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery2.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery3.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery4.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery5.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery6.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery7.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery8.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery9.jpg" class="img-fluid" alt=""/></li>
			<li><img src="<?php echo base_url(); ?>assets/images/gallery1.jpg" class="img-fluid" alt=""/></li>
		</ul>
...
<section class="start-partners home1 clearfix">
	<div class="container">
		...
		<div class="parner_reg_btn mt-4"><a href="#" class="btn">EXPLORE NOW</a></div>
	</div>
</section> 
