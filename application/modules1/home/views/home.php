...
<section class="ExclusiveProjects clearfix">
	<div class="container position-relative">
		<div class="main-title clearfix">
			...
			<p>Most acclaimed properties on Investors Clinic</p>
		</div>	
		<div class="slider exclusive-slider">
<?php if($exclusive_projects) { foreach($exclusive_projects as $ex_project){ ?>
			<div class="exclusiveIndent" style="background: url(<?php echo base_url(); ?>uploads/projects/<?php echo $ex_project->bg_image; ?>) center top no-repeat; background-size: cover;">
...
<section class="ExploreCommercial clearfix">
	<div class="container">
		<div class="main-title">
			<h2>Explore Commercial Properties in Noida</h2>
			<p>Browse Commercial Real Estate investment options on Noida's No. 1 Commercial Property Platform.</p>
		</div>
...
<section class="DiscoverFeature bglight clearfix">
	<div class="container">
		<div class="main-title clearfix">
			<h2>Guaranteed Return Projects</h2>
...
<section class="start-partners home1 clearfix">
	<div class="container">
		...
		<div class="parner_reg_btn mt-4"><a href="<?php echo base_url();?>home/about" class="btn">EXPLORE NOW</a></div>
	</div>
</section> 
